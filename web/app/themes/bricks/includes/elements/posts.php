...
class Element_Posts extends Element {
	...
	public function set_controls() {
		...
		$this->controls['imagePosition'] = [
			...
			// 'deprecated'  => true, // NOTE: Undocumented
			'inline'      => true,
		...
		$this->controls['width'] = [
			...
			'css'      => [
				[
					'property' => 'flex-basis',
					'selector' => '.bricks-layout-wrapper[data-layout=list] .image-wrapper',
				],
				[
					'property' => 'max-width',
					'selector' => '.bricks-layout-wrapper[data-layout=grid] .image-wrapper',
				],
				[
					'property' => 'max-width',
		...
		$this->controls['imageRatio'] = [
			'tab'         => 'content',
			'group'       => 'image',
			'label'       => esc_html__( 'Grid image ratio', 'bricks' ),
			'type'        => 'select',
	...
	public function render() {
		...
		// Image wrapper classes (required for CSS filter)
		$image_wrapper_classes = [ 'image-wrapper' ];

		if ( $layout === 'grid' && ! empty( $settings['imageRatio'] ) ) {
			$image_wrapper_classes[] = "bricks-{$settings['imageRatio']}";
		}
