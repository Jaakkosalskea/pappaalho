	...
	<div class="bricks-admin-inner">
		<form id="bricks-license-key-form" method="post">
			...
			if ( $license_key ) {
				...
				?>
			<p><?php printf( __( 'You can manage your license, update payment method and view your invoices right from %s.', 'bricks' ), '<a href="' . BRICKS_REMOTE_ACCOUNT . '" target="_blank">' . esc_html__( 'your account', 'bricks' ) . '</a>' ); ?></p>
			...
			<div class="form-group">
				...
				<input type="submit" value="<?php esc_html_e( 'Deactive license', 'bricks' ); ?>" class="button button-secondary button-large">
			</div>
			...
			<div class="status-wrapper">
				...
				<p class="license-mismatch"><?php esc_html_e( 'Your website does not match your license key. Please deactive and then reactivate your license.', 'bricks' ); ?></p>
			<?php } elseif ( $license_status === 'license_key_invalid' ) { ?>
				<p class="license-mismatch"><?php esc_html_e( 'Your provided license key is invalid. Please deactive and then reactivate your license.', 'bricks' ); ?></p>
			<?php } ?>
				...
				<p><?php printf( __( 'Log in to %s to retrieve your license key or copy & paste it from your purchase confirmation email.', 'bricks' ), '<a href="' . BRICKS_REMOTE_ACCOUNT . '" target="_blank">' . esc_html__( 'your account', 'bricks' ) . '</a>' ); ?></p>
